						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="wow lightSpeedIn" data-wow-delay="0.1s">
									<div class="cta-btn">
<!--										<a href="#service" class="btn btn-skin btn-lg">Participate</a>-->
									</div>
								</div>
							</div>
						</div>
			...
			<div class="row">
				<div class="col-sm-4 col-md-4">
					<div class="wow fadeInUp" data-wow-delay="0.2s">
						...
						<div class="wow lightSpeedIn" data-wow-delay="0.1s">
							<div class="cta-btn">
								<a href="cases/cp-alzheimer-0120161106v1.html" target="_blank" class="btn btn-skin btn-lm"><?php echo _("Comenta Online"); ?></a>
							</div>
						</div>
					</div>
				</div>
				<div class="col-sm-4 col-md-4">
					<div class="wow fadeInUp" data-wow-delay="0.2s">
						...
						<div class="wow lightSpeedIn" data-wow-delay="0.1s">
							<div class="cta-btn">
								<a href="cases/cp-alzheimer-0220161106v2.html" target="_blank" class="btn btn-skin btn-lm"><?php echo _("Comenta Online"); ?></a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-sm-4 col-md-4">
					<div class="wow fadeInUp" data-wow-delay="0.2s">
						...
						<div class="wow lightSpeedIn" data-wow-delay="0.1s">
							<div class="cta-btn">
								<a href="cases/cp-parkinson-wtv-0520161106v1.html" target="_blank" class="btn btn-skin btn-lm"><?php echo _("Comenta Online"); ?></a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-sm-4 col-md-4">
					<div class="wow fadeInUp" data-wow-delay="0.2s">
						...
						<div class="wow lightSpeedIn" data-wow-delay="0.1s">
							<div class="cta-btn">
								<a href="cases/cp-personas-enfdi-0320161106v1.html" target="_blank" class="btn btn-skin btn-lm"><?php echo _("Comenta Online"); ?></a>
							</div>
						</div>
					</div>
				</div>
				<div class="col-sm-4 col-md-4">
					<div class="wow fadeInUp" data-wow-delay="0.2s">
						...
						<div class="wow lightSpeedIn" data-wow-delay="0.1s">
							<div class="cta-btn">
								<a href="cases/cp-multitudes-0420161110v2.html" target="_blank" class="btn btn-skin btn-lm"><?php echo _("Comenta Online"); ?></a>
							</div>
						</div>
					</div>
				</div>
				<div class="col-sm-4 col-md-4">
					<div class="wow fadeInUp" data-wow-delay="0.2s">
						...
						<div class="wow lightSpeedIn" data-wow-delay="0.1s">
							<div class="cta-btn">
								<a href="cases/cp-model-tool-0420161106v1.html" target="_blank" class="btn btn-skin btn-lm"><?php echo _("Comenta Online"); ?></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-8 col-lg-offset-2">
					<div class="wow fadeInDown" data-wow-delay="0.1s">
						<div class="section-heading text-center">
							<h2 class="h-bold"><?php echo _("Practical Cases Comments"); ?></h2>
							<p></p>
						</div>
					</div>
					...
					<div id="grid-container" class="cbp-l-grid-team">
						<ul>
							<li class="cbp-item alzheimer">
								<a href="cases/cp-alzheimer-0120161106v1.html" class="cbp-caption cbp-singlePage">
									<div class="cbp-caption-defaultWrap">
										<img src="images/img-confusion-alzheimer.png" alt="" width="100%" height="100%">
									</div>
							...
							<li class="cbp-item alzheimer">
								<a href="cases/cp-alzheimer-0220161106v2.html" class="cbp-caption cbp-singlePage">
									<div class="cbp-caption-defaultWrap">
										<img src="images/img-desorientacion-midnigth.png" alt="" width="100%" height="100%">
									</div>
									<div class="cbp-caption-activeWrap">
										<div class="cbp-l-caption-alignCenter">
											<div class="cbp-l-caption-body">
							...
							<li class="cbp-item parkinson">
								<a href="cases/cp-parkinson-wtv-0520161106v1.html" class="cbp-caption cbp-singlePage">
									<div class="cbp-caption-defaultWrap">
										<img src="images/img-parkinson-watching-tv.png" alt="" width="100%" height="100%">
									</div>
									<div class="cbp-caption-activeWrap">
										<div class="cbp-l-caption-alignCenter">
											<div class="cbp-l-caption-body">
							...
							<li class="cbp-item crowds">
								<a href="cases/cp-personas-enfdi-0320161106v1.html" class="cbp-caption cbp-singlePage">
									<div class="cbp-caption-defaultWrap">
										<img src="images/img-personas-en-fdi.png" alt="" width="100%" height="100%">
									</div>
									<div class="cbp-caption-activeWrap">
										<div class="cbp-l-caption-alignCenter">
											<div class="cbp-l-caption-body">
							...
							<li class="cbp-item crowds">
								<a href="cases/cp-multitudes-0420161110v2.html" class="cbp-caption cbp-singlePage">
									<div class="cbp-caption-defaultWrap">
										<img src="images/img-flujo-multitudes.png" alt="" width="100%" height="100%">
									</div>
									<div class="cbp-caption-activeWrap">
										<div class="cbp-l-caption-alignCenter">
											<div class="cbp-l-caption-body">
							...
							<li class="cbp-item crowds">
								<a href="cases/cp-model-tool-0420161106v1.html" class="cbp-caption cbp-singlePage">
									<div class="cbp-caption-defaultWrap">
										<img src="images/img-model-tool.png" alt="" width="100%" height="100%">
									</div>
									<div class="cbp-caption-activeWrap">
										<div class="cbp-l-caption-alignCenter">
											<div class="cbp-l-caption-body">
