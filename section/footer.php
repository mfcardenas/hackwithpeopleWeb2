...
<footer>
                    ...
                    <div class="widget">
                        ...
                        <ul>
                            <li>
								...
								</span> +34 91-394-7501 - +34 91-394-7599
                            </li>
                            <li>
								<span class="fa-stack fa-lg">
									<i class="fa fa-circle fa-stack-2x"></i>
                    ...
                    <div>
                        ...
                        <p>
                            <a href="http://www.madrid.org" target="_blank">
                                <img src="images/img-logo-comunidad-madrid.jpg"  height="50" width="200" title="Comunidad de Madrid"
                ...
                <div>
                    <p>
                        <a rel="license" href="http://www.mineco.gob.es/" target="_blank">
                            <img src="images/gobspain.png" height="40" width="166" alt="Gobierno de España"
    ...
    <script type="text/javascript">
        var _paq = _paq || [];
        _paq.push(["setDomains", ["*.grasia.fdi.ucm.es/hack4people","*.grasia.fdi.ucm.es/hack4people"]]);
        _paq.push(['trackPageView']);
        _paq.push(['enableLinkTracking']);
        (function() {
            var u="//grasia.fdi.ucm.es/grasiastats/";
    ...
    <noscript><p><img src="//grasia.fdi.ucm.es/grasiastats/piwik.php?idsite=25" style="border:0;" alt="" /></p></noscript>
    <!-- End Piwik Code -->
    <!-- Piwik Image Tracker-->
    <img src="http://grasia.fdi.ucm.es/grasiastats/piwik.php?idsite=21&rec=1" style="border:0" alt="" />
    <!-- End Piwik -->
</footer>